...
unset($__errorArgs, $__bag); ?>" 
                                       name="sku" value="<?php echo e(old('sku')); ?>" required>
                                <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                                  name="short_description" rows="2" maxlength="500"><?php echo e(old('short_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                name="description" id="description" rows="6"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                name="additional_information" id="additional_information" rows="6"><?php echo e(old('additional_information')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       name="brand" value="<?php echo e(old('brand')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="price" value="<?php echo e(old('price')); ?>" step="0.01" min="0" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="compare_price" value="<?php echo e(old('compare_price')); ?>" step="0.01" min="0">
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="cost_price" value="<?php echo e(old('cost_price')); ?>" step="0.01" min="0">
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="discount_percentage" value="<?php echo e(old('discount_percentage', 0)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       name="quantity" value="<?php echo e(old('quantity', 0)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       name="min_quantity" value="<?php echo e(old('min_quantity', 0)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" class="form-check-input" name="track_inventory" 
                               value="1" <?php echo e(old('track_inventory', 1) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="weight" value="<?php echo e(old('weight')); ?>" step="0.001" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="length" value="<?php echo e(old('length')); ?>" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="width" value="<?php echo e(old('width')); ?>" step="0.01" min="0">
                                    <span class="input-group-text">cm</span>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="height" value="<?php echo e(old('height')); ?>" step="0.01" min="0">
                                    <span class="input-group-text">cm</span>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                               name="meta_title" value="<?php echo e(old('meta_title')); ?>" maxlength="255">
...
unset($__errorArgs, $__bag); ?>" 
                                  name="meta_description" rows="3" maxlength="500"><?php echo e(old('meta_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" class="form-check-input" name="is_digital" 
                               value="1" <?php echo e(old('is_digital') ? 'checked' : ''); ?>>
                                    ...
                                    <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" 
                                                   ...
                                                   <?php echo e(in_array($child->id, old('categories', [])) ? 'checked' : ''); ?>>
                                            <label class="form-check-label">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u391893744/domains/gitcsdemoserver.online/public_html/carcare/resources/views/admin/products/create.blade.php ENDPATH**/ ?>