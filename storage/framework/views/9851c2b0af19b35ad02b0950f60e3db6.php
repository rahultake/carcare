...
unset($__errorArgs, $__bag); ?>" 
                                       name="slug" value="<?php echo e(old('slug', $category->slug)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                  name="description" rows="4"><?php echo e(old('description', $category->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       name="icon" value="<?php echo e(old('icon', $category->icon)); ?>" placeholder="fas fa-car">
...
unset($__errorArgs, $__bag); ?>" 
                                       name="sort_order" value="<?php echo e(old('sort_order', $category->sort_order)); ?>" min="0">
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="border-end">
                            <h4 class="text-primary"><?php echo e($category->products->count()); ?></h4>
                            <small class="text-muted">Products</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <h4 class="text-info"><?php echo e($category->children->count()); ?></h4>
                    ...
                    <ul class="list-unstyled">
                        <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mb-1">
                                ...
                                <span class="badge bg-light text-dark ms-1"><?php echo e($child->products->count()); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u391893744/domains/gitcsdemoserver.online/public_html/carcare/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>